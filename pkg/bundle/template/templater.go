...
func NewTemplaterFunc(cfg *rest.Config) func(ctx context.Context, bundle *bundlev1.Bundle, dir string) ([]byte, error) {
...
func (t Templater) Template(ctx context.Context, plugin *bundlev1.Bundle, dir string) ([]byte, error) {
